...
\begin{frame}
    ...
    \begin{itemize}
    	...
    	\item Implement functions relevant to the plugin
    \end{itemize}
\end{frame}
...
\begin{frame}
    ...
    \begin{itemize}
    	...
    	\item{Setup CI to run test using your plugin, and to keep it tested}
    \end{itemize}
\end{frame}

\begin{frame}
    \frametitle{Tempest Plugin Interface}
        \lstinputlisting[basicstyle=\tiny]{tempest_plugin.py}
\end{frame}
...
\begin{frame}
    ...
    \item settings
        \begin{itemize}
            \item register the project for upgrade
            \item 
        \end{itemize}
    \item resources.sh
        \begin{itemize}
